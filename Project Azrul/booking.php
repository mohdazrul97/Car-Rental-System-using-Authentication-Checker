...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h2 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Rent a car now </h2><br>
        ...
        <h5> Choose your car type:  &nbsp;
            <input onclick="reveal()" type="radio" name="radio" value="auto" ng-model="myVar"> Auto &nbsp;
            <input onclick="reveal()" type="radio" name="radio" value="manual" ng-model="myVar"> Manual
        ...
        <div ng-switch-default>
                ...
                <!-- </div>    -->
                    ...
                    <!-- <div class="form-group"> -->
                <h5>Fare: <?php echo("RM" . $auto_price . "/km and RM" . $auto_price_per_day . "/day");?><h5>    
                <!-- </div>    -->
                     </div>
                     <div ng-switch-when="non_ac">
                     <!-- <div class="form-group"> -->
                <h5>Fare: <?php echo("RM" . $manual_price . "/km and RM" . $manual_price_per_day . "/day");?><h5>    
                <!-- </div>   -->
                     </div>
        </div>
      ...
      <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6><strong>Kindly Note:</strong> You will be charged <span class="text-danger">RM200/-</span> for each day after the due date.</h6>
        </div>
    </div>
