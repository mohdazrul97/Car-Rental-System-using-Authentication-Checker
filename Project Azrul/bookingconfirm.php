...
<?php
    ...
    if (mysqli_num_rows($result0) > 0) {
        while($row0 = mysqli_fetch_assoc($result0)) {
            ...
            if($type == "ac" && $charge_type == "km"){
                $fare = $row0["auto_price"];
            } else if ($type == "auto" && $charge_type == "days"){
                $fare = $row0["auto_price_per_day"];
            } else if ($type == "manual" && $charge_type == "km"){
                $fare = $row0["manual_price"];
            } else if ($type == "manual" && $charge_type == "days"){
                $fare = $row0["manual_price_per_day"];
            } else {
                $fare = "NA";
            }
        }
    ...
    if($err_date >= 0) { 
    $sql1 = "INSERT into rentedcars(customer_username,car_id,driver_id,booking_date,rent_start_date,rent_end_date,fare,charge_type,return_status,hashed) 
    VALUES('" . $customer_username . "','" . $car_id . "','" . $driver_id . "','" . date("Y-m-d") ."','" . $rent_start_date ."','" . $rent_end_date . "','" . $fare . "','" . $charge_type . "','" . $return_status . "','" .$val2. "')";
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <div class="container">
            ...
            <h1 class="text-center" style="color: red;"><span class="glyphicon glyphicon-ok-circle"></span> Booking Are Confirmed.</h1>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                if($charge_type == "days"){
                ?>
                     <h4> <strong>Fare:</strong> RM<?php echo $fare; ?>/day</h4>
                <?php } else {
                    ?>
                    <h4> <strong>Fare:</strong> RM<?php echo $fare; ?>/km</h4>
                ...
                <textarea id="text-val" rows="4"><?php echo "$id"; ?>.txt<?php echo "$car_name"; ?><?php echo "$car_nameplate"; ?><?php echo "$fare"; ?><?php echo date("Y-m-d"); ?><?php echo "$rent_start_date"; ?><?php echo "$rent_end_date"; ?><?php echo "$driver_name"; ?><?php echo "$driver_gender"; ?><?php echo "$driver_phone"; ?><?php echo "$dl_number"; ?><?php echo "$client_name"; ?><?php echo "$client_phone"; ?></textarea><br/>
                ...
                <?php
                    ...
                    $txt = $id.''. $car_name .''. $car_nameplate .''. $fare .''. date("Y-m-d") .''. $rent_start_date .''. $rent_end_date .''. $driver_name .''. $driver_gender .''. $driver_phone .''. $dl_number .''. $client_name .''. $client_phone  ;
                ...
                $id2 =  str_replace(".txt", "", $txt);

                echo $id2;
              
                $resultHash = hash_hmac('md5', $txt, 'key');
                

                  $sql50 = "UPDATE rentedcars SET hashed = '$resultHash' WHERE car_id = '$car_id'";
